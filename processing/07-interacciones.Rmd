...
int1 <- plot_model(reg11_bienestar, type = "int", mdrt.values="meansd", title = "") +
  theme_bw() +
  labs(x = "Parental educational level", y="Index of Access to social services", colour = "Deservingness")
...
int2 <- plot_model(reg26_bienestar, type = "int", mdrt.values="meansd", title = "") +
  theme_bw() +
  labs(x = "School Simce", y="Index of Access to social services", colour = "Deservingness")
...
int1.2 <- sjPlot::plot_model(reg11.2_bienestar, type = "int", title = "", colors = c("red", "blue", "white")) +
  theme_bw() +
  labs(x ="Deservingness" , y="Index of Access to social services", colour = "Parental educational level")
int1.2
...
int2.2 <- plot_model(reg26.2_bienestar, type = "int", mdrt.values="minmax", title = "", colors = c("red", "white", "blue")) +
  theme_bw() +
  labs(x = "Deservingness", y="Index of Access to social services", colour = "School Simce")
int2.2
