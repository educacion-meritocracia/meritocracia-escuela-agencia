...
labels2 <- rev(labels)
plot1 <- plot_model(reg5_bienestar, title = "", show.values = TRUE, value.offset = .4, axis.labels = labels2)
plot1
...
```{r}
varcomp_0=as.data.frame(lme4::VarCorr(reg0_bienestar))
tau00_0=varcomp_0[1,4]
sigma2_0=varcomp_0[2,4]

varcomp_1=as.data.frame(lme4::VarCorr(reg1_bienestar))
tau00_1=varcomp_1[1,4]
sigma2_1=varcomp_1[2,4]

varcomp_2=as.data.frame(lme4::VarCorr(reg2_bienestar))
tau00_2=varcomp_2[1,4]
sigma2_2=varcomp_2[2,4]

varcomp_3=as.data.frame(lme4::VarCorr(reg3_bienestar))
tau00_3=varcomp_3[1,4]
sigma2_3=varcomp_3[2,4]

varcomp_4=as.data.frame(lme4::VarCorr(reg4_bienestar))
tau00_4=varcomp_4[1,4]
sigma2_4=varcomp_4[2,4]

varcomp_5=as.data.frame(lme4::VarCorr(reg5_bienestar))
