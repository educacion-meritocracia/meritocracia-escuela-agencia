...
plot_soc_effort <- soc_effort %>% ggplot(aes(esfuerzo_soc, mean)) +
  ...
  scale_x_continuous(limits = c(1, 4),
                     ...
                     label = c("Strongly disagree", 
                               ...
                               "Agree", 
                               "Strongly agree")) +
  labs(color = "Justification of inequality", shape = "Justification of inequality", title = "             Social Meritocracy")
...
plot_school_effort <- school_effort %>% ggplot(aes(esfuerzo_esc, mean)) +
  ...
  scale_x_continuous(limits = c(1, 4),
                     ...
                     label = c("Strongly disagree", 
                               ...
                               "Agree", 
                               "Strongly agree")) +
  labs(color = "Justification of inequality", shape = "Justification of inequality", title = "             School Meritocracy")
...
plot_merit_justice <- ggarrange(plot_soc_effort, plot_school_effort, plot_deservingness, plot_school_talent, plot_soc_talent, common.legend = TRUE, ncol = 2, nrow = 3)
plot_merit_justice
...
```{r}
plots2<-plot_models(reg5_salud, reg5_pension, reg5_educ, 
